# Generated by Powerlevel10k configuration wizard on 2023-03-10 at 19:37 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=222
  # Custom icon.
...
function prompt_my_volta() {
  ...
  p10k segment -b green -f black -ri NODE_ICON -t "${version#v}"
}
